...
<div style="text-align: center;">
  <h2><i>Boana rosenbergi</i></h2>
  <h4>(Boulenger, 1898)</h4>
  <img src="{{ site.baseurl }}/images/especie_Boana_rosenbergi.png" style="width:15cm;">
</div>
...
<div id="Espectro" class="tabcontent" style="text-align: center;">
  <video width="100%" height="auto" controls>
    <source src="{{ site.baseurl }}/Espectrograms/dyna_Boana_rosenbergi.mp4" type="video/mp4">
...
<div id="fig" class="tabcontent" style="text-align: center;">
  <img src="{{ site.baseurl }}/images/spec_Boana_rosenbergi.png" style="width:15cm;">
</div>
